# OpenRouter モデルカタログ（全594モデル）

- 取得日時: 2026-09-13T06:40:30
- プロバイダ数: 76 / 無料枠あり: 28
...
|---|--:|--:|--:|--:|
| openai | 111 | 0.00 | 6,000.00 | 1,050,000 |
| qwen | 63 | 0.00 | 35.00 | 1,048,576 |
| google | 52 | 0.00 | 16,000.00 | 1,048,576 |
| mistralai | 31 | 0.02 | 3,000.00 | 262,144 |
| anthropic | 27 | 0.25 | 15.00 | 1,000,000 |
| deepseek | 18 | 0.04 | 0.80 | 1,310,720 |
| z-ai | 17 | 0.06 | 1.20 | 1,310,720 |
| recraft | 15 | 0.00 | 0.00 | 65,536 |
| nvidia | 15 | 0.00 | 1,500.00 | 1,000,000 |
| minimax | 14 | 0.00 | 100.00 | 1,048,576 |
| x-ai | 13 | 0.00 | 100,000.00 | 2,000,000 |
| microsoft | 10 | 0.07 | 360,000.00 | 65,535 |
| meta | 9 | 0.00 | 180,000.00 | 1,048,576 |
| bytedance-seed | 9 | 0.00 | 0.50 | 262,144 |
| moonshotai | 8 | 0.45 | 3.00 | 1,048,576 |
...
| inclusionai | 6 | 0.00 | 0.06 | 262,144 |
| alibaba | 6 | 0.00 | 0.00 | 0 |
| bytedance | 6 | 0.00 | 0.10 | 128,000 |
| thinkingmachines | 6 | 0.00 | 1.00 | 1,048,576 |
| ~openai | 5 | 0.20 | 10.00 | 1,050,000 |
...
Aion-3.0 is a multi-model roleplaying and storytelling system from AionLabs, built on the GLM family of models. It uses a collaborative generation process in which multiple specialized models each contribute to a response, producing stronger narrative structure and more compelling tension and conflict.
...
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Generation $0.0988〜$0.1694/second
...
- **Context**: — tok
- **Modality**: text+image->video  (in: text,image → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Generation $0.0988〜$0.1278/second
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-06-24
- **対応パラメータ**: max_tokens, temperature, top_p, seed, presence_penalty, response_format
...
- **Context**: — tok
- **Modality**: text+image->video  (in: text,image → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Generation $0.0425〜$0.17/second
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-08-24
- **対応パラメータ**: max_tokens, temperature, top_p, seed, presence_penalty, response_format
...
- **Context**: — tok
- **Modality**: text+image->video  (in: text,image → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Generation $0.068〜$0.28/second
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-08-27
- **対応パラメータ**: max_tokens, temperature, top_p, seed, presence_penalty, response_format

Wan 3.0 Prime is a fast-mode variant of [Wan 3.0](https://openrouter.ai/alibaba/wan-3.0) from Alibaba. It supports text-to-video and first-frame image-to-video generation.
...
- **登録日**: 2025-12-02
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, top_k, stop, tool_choice, tools
...
- **登録日**: 2024-12-05
- **対応パラメータ**: max_tokens, temperature, top_p, top_k, stop, tools
...
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.25/1M · 出力 $1.25/1M · キャッシュ読 $0.03/1M · キャッシュ書 $0.3/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice
- **Knowledge cutoff**: 2023-08-31T23:59:59.000Z
- **登録日**: 2024-03-13
...
- **Context**: 1M (1,000,000) tok / max出力 128,000 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $10.00/1M · 出力 $50.00/1M · キャッシュ読 $0.25/1M · キャッシュ書 $12.50/1M · Web検索 $0.01
- **Capabilities**: Function calling, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-09-01
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, max_tokens, max_completion_tokens, tools, response_format, verbosity, stop
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2025-10-15
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, max_tokens, temperature, top_p, max_completion_tokens, tools, tool_choice, top_k, response_format
...
- **登録日**: 2025-05-22
- **対応パラメータ**: max_tokens, top_p, temperature, stop, reasoning, include_reasoning, tools, tool_choice
...
- **Knowledge cutoff**: 2025-01-31T00:00:00.000Z
- **登録日**: 2025-08-05
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, top_k, stop, tools, tool_choice
...
Opus 4.5 supports advanced tool use, extended context management, …
...
Beyond coding, Opus 4.7 brings improved knowledge work capabilities - from drafting documents and building presentations to analyzing data. It maintains coherence across very long outputs and extended sessions, making it a strong default for …
...
Sonnet 4.5 also introduces stronger agentic capabilities, including improved tool orchestration, speculative parallel execution, and more efficient context and memory management. With enhanced context tracking and awareness of token usage across tool …
...
- **ID**: `baai/bge-m3`
- **Provider**: baai
- **Context**: 8K (8,194) tok / max出力 8,194 tok
- **Modality**: text->embeddings  (in: text → out: embeddings)
- **Pricing**: 入力 $0.01/1M · 出力 無料/1M
- **Capabilities**: Seed固定
- **登録日**: 2025-11-18
- **HF**: `BAAI/bge-m3`
- **対応パラメータ**: max_tokens, temperature, top_p, frequency_penalty, presence_penalty, repetition_penalty, seed, stop, top_k, logit_bias
...
- **Provider**: black-forest-labs
- **Context**: — tok
- **Modality**: text+video->video  (in: text,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Edit Output $0.03/second
- **登録日**: 2026-09-10
...
- **Context**: — tok
- **Modality**: text+video->video  (in: text,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Upscale Output $0.075〜$0.105/megapixel-second
- **登録日**: 2026-08-19
...
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Input $0.06/megapixel · Image Output $0.06/megapixel
- **Capabilities**: Seed固定
- **登録日**: 2025-11-25
- **対応パラメータ**: seed
...
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.014/megapixel
- **Capabilities**: Seed固定
- **登録日**: 2026-01-14
...
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.07/megapixel
- **Capabilities**: Seed固定
- **登録日**: 2025-12-16
- **対応パラメータ**: seed
...
- **Context**: 46K (46,864) tok
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.03/megapixel
- **Capabilities**: Seed固定
- **登録日**: 2025-11-25
- **対応パラメータ**: seed
...
- **Context**: — tok
- **Modality**: text+image->video  (in: text,image → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video (with audio) $0.0230592〜$0.46656/second · Video (no audio) $0.0115296〜$0.23328/second · Video Tokens (with audio) $2.4e-06/M tokens · Video Tokens (no audio) $1.2e-06/M tokens
- **登録日**: 2026-03-23
...
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video (with audio) $0.067256〜$0.7776/second · Video (no audio) $0.067256〜$0.7776/second · Video (with video input) $0.0413144〜$0.46656/second · Video Tokens (with audio) $7e-06/M tokens · Video Tokens (no audio) $7e-06/M tokens · Video Tokens (with video input) $4.3e-06/M tokens
- **登録日**: 2026-04-15
- **対応パラメータ**: frequency_penalty
...
- **Context**: — tok
- **Modality**: text+image+audio+video->video  (in: text,image,audio,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video (with audio) $0.0403536〜$0.81648/second · Video (no audio) $0.0403536〜$0.81648/second · Video (with video input) $0.0237798〜$0.48114/second · Video Tokens (with audio) $4.2e-06/M tokens · Video Tokens (no audio) $4.2e-06/M tokens · Video Tokens (with video input) $2.475e-06/M tokens
- **登録日**: 2026-04-15
- **対応パラメータ**: frequency_penalty
...
- **Context**: — tok
- **Modality**: text+image+audio+video->video  (in: text,image,audio,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video (with audio) $0.033628〜$0.6804/second · Video (no audio) $0.033628〜$0.6804/second · Video (with video input) $0.0201768〜$0.40824/second · Video Tokens (with audio) $3.5e-06/M tokens · Video Tokens (no audio) $3.5e-06/M tokens · Video Tokens (with video input) $2.1e-06/M tokens
- **登録日**: 2026-08-12
- **対応パラメータ**: frequency_penalty
...
- **Context**: — tok
- **Modality**: text+image+audio+video->video  (in: text,image,audio,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video (with audio) $0.102806〜$2.08008/second · Video (no audio) $0.102806〜$2.08008/second · Video (with video input) $0.0614912〜$1.24416/second · Video Tokens (with audio) $1.07e-05/M tokens · Video Tokens (no audio) $1.07e-05/M tokens · Video Tokens (with video input) $6.4e-06/M tokens
- **登録日**: 2026-08-07
- **対応パラメータ**: frequency_penalty
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-03-10
- **対応パラメータ**: reasoning, include_reasoning, frequency_penalty, max_tokens, temperature, top_p, structured_outputs, tool_choice, tools, response_format, stop
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, seed, structured_outputs, response_format
...
- **Knowledge cutoff**: 2024-03-31T23:59:59.000Z
- **登録日**: 2024-08-30
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, seed, structured_outputs, response_format, tools, tool_choice
...
- **Provider**: cohere
- **Context**: 256K (256,000) tok / max出力 64,000 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 無料/1M · 出力 無料/1M  🆓
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-06-17
- **HF**: `CohereLabs/North-Mini-Code-1.0`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, seed, tools, tool_choice
...
- **Context**: — tok
- **Modality**: text->speech  (in: text → out: speech)
- **Pricing**: 入力 $30.00/1M · 出力 無料/1M · Characters $3e-05/M characters
- **登録日**: 2026-07-16
...
- **Pricing**: 入力 $4,300.00/1M · 出力 無料/1M · Audio Minutes $0.0043/minute · Audio Minutes (Multilingual) $0.0052/minute
- **登録日**: 2026-07-15
...
- **対応パラメータ**: response_format, structured_outputs, tools, tool_choice, max_tokens, temperature, top_p, stop, presence_penalty
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format, logit_bias, tools, tool_choice, structured_outputs
...
The model improves tool use, code generation, and reasoning efficiency, achieving performance comparable to DeepSeek-R1 on difficult benchmarks while responding more quickly. It supports …

#### DeepSeek: R1

- **ID**: `deepseek/deepseek-r1`
- **Provider**: deepseek
- **Context**: 64K (64,000) tok / max出力 16,000 tok
- **Modality**: text->text  (in: text → out: text)
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.0498/1M · 出力 $0.0997/1M · キャッシュ読 $0.01/1M
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.0352/1M · 出力 $0.1056/1M · キャッシュ読 $0.0011/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-07-31
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.11/1M · 出力 $0.33/1M · キャッシュ読 $0.0035/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-07-31
- **HF**: `deepseek-ai/DeepSeek-V4-Flash-0731`
...
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.2156/1M · 出力 $0.6468/1M · キャッシュ読 $0.0069/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-08-21
...
- **Context**: 1.04858M (1,048,576) tok / max出力 384,000 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.6267/1M · 出力 $1.25/1M · キャッシュ読 $0.0522/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-04-24
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.5782/1M · 出力 $1.73/1M · キャッシュ読 $0.0184/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-08-12
...
- **Context**: 1.04858M (1,048,576) tok / max出力 384,000 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.15/1M · 出力 $0.6/1M · キャッシュ読 $0.003/1M
...
It is suited for coding, terminal, and computer-use agents, along with long-horizon tasks that …
...
- **Context**: — tok
- **Modality**: text->speech  (in: text → out: speech)
- **Pricing**: 入力 $15.00/1M · 出力 無料/1M · UTF-8 Bytes $1.5e-05/M UTF-8 bytes
- **登録日**: 2026-07-29
...
- **Context**: — tok
- **Modality**: audio->transcription  (in: audio → out: transcription)
- **Pricing**: 入力 $100.00/1M · 出力 無料/1M · Audio Seconds $0.0001/second
- **登録日**: 2026-07-29
...
- **Knowledge cutoff**: 2025-01-31T00:00:00.000Z
- **登録日**: 2025-06-17
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, tools, tool_choice, stop
...
- **Context**: 1.04858M (1,048,576) tok / max出力 65,535 tok
- **Modality**: text+image+file+audio+video->text  (in: text,image,file,audio,video → out: text)
- **Pricing**: 入力 $0.05/1M · 出力 $0.2/1M · キャッシュ読 $0.01/1M · 推論 $0.2/1M · 画像 $5e-08/枚 · 音声 $0.15/1M · Web検索 $0.014
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2025-01-31T23:59:59.000Z
- **登録日**: 2025-07-22
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, tools, tool_choice, stop
...
- **Context**: 1.04858M (1,048,576) tok / max出力 65,535 tok
- **Modality**: text+image+file+audio+video->text  (in: text,image,file,audio,video → out: text)
- **Pricing**: 入力 $0.15/1M · 出力 $1.25/1M · キャッシュ読 $0.03/1M · 推論 $1.25/1M · 画像 $1.5e-07/枚 · 音声 $0.5/1M · Web検索 $0.014
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2025-01-31T00:00:00.000Z
- **登録日**: 2025-06-17
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, tools, tool_choice, stop
...
- **Provider**: google
- **Context**: 1.04858M (1,048,576) tok / max出力 65,536 tok
- **Modality**: text+image+file+audio->text  (in: text,image,file,audio → out: text)
- **Pricing**: 入力 $1.25/1M · 出力 $10.00/1M · キャッシュ読 $0.125/1M · キャッシュ書 $0.375/1M · 推論 $10.00/1M · 画像 $1.25e-06/枚 · 音声 $1.25/1M · Web検索 $0.014
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2025-01-31T23:59:59.000Z
- **登録日**: 2025-06-05
...
- **Context**: 1.04858M (1,048,576) tok / max出力 65,536 tok
- **Modality**: text+image+file+audio+video->text  (in: text,image,file,audio,video → out: text)
- **Pricing**: 入力 $0.625/1M · 出力 $5.00/1M · キャッシュ読 $0.125/1M · 推論 $5.00/1M · 画像 $6.25e-07/枚 · 音声 $0.625/1M · Web検索 $0.014
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2025-01-31T23:59:59.000Z
- **登録日**: 2025-06-17
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, tools, tool_choice, stop
...
The model supports a 1M token context window and multimodal inputs including text, images, audio, video, and PDFs, with text output. It includes configurable reasoning via thinking levels (minimal, …
...
It offers industry-leading text rendering in images (including long passages and multilingual layouts), consistent multi-image blending, and accurate identity preservation across up to five subjects. Nano Banana Pro adds fine-grained creative controls such as localized edits, lighting and …
...
- **Modality**: text+image+file+audio+video->embeddings  (in: text,image,file,audio,video → out: embeddings)
- **Pricing**: 入力 $0.2/1M · 出力 無料/1M · 画像 $4.5e-07/枚 · 音声 $6.50/1M
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-05-20
- **対応パラメータ**: max_tokens, temperature, top_p, seed, response_format
...
- **Context**: 8K (8,192) tok
- **Modality**: text+image+file+audio+video->embeddings  (in: text,image,file,audio,video → out: embeddings)
- **Pricing**: 入力 $0.1/1M · 出力 無料/1M · 画像 $2.25e-07/枚 · 音声 $3.25/1M
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-05-20
- **対応パラメータ**: max_tokens, temperature, top_p, seed, response_format
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format, logit_bias, structured_outputs, tools, tool_choice
...
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.39/1M · 出力 $0.97/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-04-02
- **HF**: `google/gemma-4-31B-it`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, structured_outputs, response_format, tool_choice, tools
...
- **Provider**: heygen
- **Context**: — tok
- **Modality**: text+image+audio->video  (in: text,image,audio → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Output $0.05/second
- **登録日**: 2026-08-24
...
- **対応パラメータ**: max_tokens, temperature, top_p, top_k, seed, repetition_penalty, frequency_penalty, presence_penalty, min_p, stop, logit_bias, response_format, logprobs, top_logprobs
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.06/1M · 出力 $0.25/1M · キャッシュ読 $0.015/1M
- **Capabilities**: Function calling, JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-08-31
- **HF**: `ibm-granite/granite-4.2-8b`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format, logit_bias, tools

Granite 4.2 8B is a dense reasoning model from IBM. It is suited for mathematics, code generation, multilingual dialogue, and agentic workflows that need multi-step reasoning. It supports full, low-effort, and non-thinking modes.
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-03-04
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, stop, temperature, tools, tool_choice, response_format, structured_outputs
...
- **Provider**: inception
- **Context**: 260K (260,000) tok / max出力 65,536 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.04/1M · 出力 $0.15/1M · キャッシュ読 $0.004/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-09-08
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, stop, temperature, tools, tool_choice, response_format, structured_outputs
...
- **Context**: 262K (262,144) tok / max出力 32,768 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.021/1M · 出力 $0.063/1M · キャッシュ読 $0.0042/1M
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format, logit_bias, tools, tool_choice, structured_outputs
...
- **Provider**: kwaipilot
- **Context**: 262K (262,144) tok / max出力 144,000 tok
- **Modality**: text->text  (in: text → out: text)
...
- **Provider**: liquid
- **Context**: 65K (65,536) tok / max出力 8,192 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 無料/1M · 出力 無料/1M  🆓
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-11
- **HF**: `LiquidAI/LFM2.5-2.6B`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, repetition_penalty, max_completion_tokens, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
- **Capabilities**: Seed固定
- **登録日**: 2026-08-18
- **HF**: `LiquidAI/LFM2.5-Embedding-350M`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, repetition_penalty
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.4/1M · 出力 $0.75/1M
- **Capabilities**: JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2023-06-30T23:59:59.000Z
- **登録日**: 2023-08-02
- **対応パラメータ**: response_format, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, logit_bias, top_k, min_p, seed, top_a, logprobs, top_logprobs
...
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.3/1M · 出力 $1.10/1M · キャッシュ読 $0.04/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-08-09
...
- **Context**: 131K (131,072) tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.175/1M · 出力 $0.75/1M · キャッシュ読 $0.02/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-08-09
- **HF**: `meta-models/Muse-Glimmer-30B`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, logprobs, top_logprobs, response_format, structured_outputs, tools, tool_choice
...
- **Context**: — tok
- **Modality**: audio->transcription  (in: audio → out: transcription)
- **Pricing**: 入力 $180,000.00/1M · 出力 無料/1M · Audio Hours $0.18/hour
- **登録日**: 2026-09-11
- **対応パラメータ**: max_tokens, repetition_penalty, top_k, temperature, top_p
...
- **対応パラメータ**: response_format, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, tools, tool_choice, logit_bias, structured_outputs
...
- **Provider**: meta-llama
- **Context**: 60K (60,000) tok / max出力 60,000 tok
- **Modality**: text->text  (in: text → out: text)
...
Maverick features early fusion for native multimodality and a 1 million token context window. It was trained on a curated mixture of public, licensed, and Meta-platform data, covering ~22 …

#### Meta: Llama 4 Scout

- **ID**: `meta-llama/llama-4-scout`
- **Provider**: meta-llama
- **Context**: 1.31072M (1,310,720) tok / max出力 16,384 tok
- **Modality**: text+image->text  (in: text,image → out: text)
...
MAI-Image-2.6 is an image generation and editing model from Microsoft AI, the precision tier of the MAI-Image-2.6 family alongside the faster [MAI-Image-2.6 Flash](/microsoft/mai-image-2.6-flash). It is suited for design-ready visuals and controlled, iterative editing, and is particularly strong at multi-reference editing that combines people, products, styles, and scenes from up to five input images while preserving composition, style, and detail. Aspect ratio can be fixed or left to the model to choose for the composition.
...
- **Context**: 4K (4,096) tok / max出力 1,024 tok
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 $1.75/1M · 出力 無料/1M
- **登録日**: 2026-09-04
- **対応パラメータ**: max_tokens, temperature, max_completion_tokens

MAI-Image-2.6 Flash is the lower-latency, lower-cost member of the [MAI-Image-2.6](/microsoft/mai-image-2.6) family from Microsoft AI, built for latency-sensitive, high-throughput production image generation and editing at comparable quality to the precision tier. It supports the same multi-reference editing with up to five input images and the same fixed or model-chosen aspect ratios.
...
On OpenRouter, set `response_format` to `"verbose_json"` for segment timestamps, and add `timestamp_granularities: ["word"]` for word-level …
...
- **Provider**: microsoft
- **Context**: 65K (65,535) tok / max出力 8,000 tok
- **Modality**: text->text  (in: text → out: text)
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, response_format
...
- **Context**: — tok
- **Modality**: text+image+audio+video->video  (in: text,image,audio,video → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Output $0.13/second · Reference Image (first 5 free) $0.04/image
- **登録日**: 2026-07-29
- **対応パラメータ**: max_tokens, temperature, top_p
...
- **Context**: — tok
- **Modality**: text+image->video  (in: text,image → out: video)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Video Output $0.05〜$0.08/second
- **登録日**: 2026-09-02
- **対応パラメータ**: max_tokens, temperature, top_p
...
- **Knowledge cutoff**: 2024-06-30T23:59:59.000Z
- **登録日**: 2025-06-17
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p

MiniMax-M1 is a large-scale, open-weight reasoning model designed for extended context and high-efficiency inference. It leverages a hybrid Mixture-of-Experts (MoE) architecture paired with a custom "lightning attention" mechanism, allowing it to process long sequences—up to 1 million tokens—while maintaining competitive FLOP efficiency. With 456 billion total parameters and 45.9B active per token, this variant is optimized for complex, multi-step reasoning tasks.

Trained via a custom reinforcement learning pipeline (CISPO), M1 excels in long-context understanding, software engineering, agentic tool use, and mathematical reasoning. Benchmarks show strong performance across FullStackBench, …
...
- **Provider**: minimax
- **Context**: 204K (204,800) tok / max出力 32,768 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.27/1M · 出力 $0.95/1M · キャッシュ読 $0.03/1M
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力
- **登録日**: 2026-02-12
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.21/1M · 出力 $0.84/1M · キャッシュ読 $0.042/1M
- **Capabilities**: Function calling, Tool choice, JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-03-18
...
Trained as a native multimodal model on interleaved data and tuned for multi-turn, production-like collaboration via an interactive user-simulator framework, the model is oriented toward …
...
- **Context**: — tok
- **Modality**: text->speech  (in: text → out: speech)
- **Pricing**: 入力 $100.00/1M · 出力 無料/1M · Characters $0.0001/M characters
- **登録日**: 2026-07-16
- **対応パラメータ**: max_tokens, temperature, top_p
...
- **Context**: — tok
- **Modality**: text->speech  (in: text → out: speech)
- **Pricing**: 入力 $60.00/1M · 出力 無料/1M · Characters $6e-05/M characters
- **登録日**: 2026-07-16
- **対応パラメータ**: max_tokens, temperature, top_p
...
- **Modality**: text+file->text  (in: text,file → out: text)
- **Pricing**: 入力 $0.15/1M · 出力 $0.45/1M · キャッシュ読 $0.015/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **Knowledge cutoff**: 2025-03-31T23:59:59.000Z
- **登録日**: 2025-08-01
- **対応パラメータ**: structured_outputs, response_format, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, prediction, tools, tool_choice
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tool_choice, tools
...
- **Context**: 262K (262,144) tok / max出力 262,144 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.075/1M · 出力 $0.075/1M · キャッシュ読 $0.0075/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **登録日**: 2025-12-02
- **HF**: `mistralai/Ministral-3-8B-Instruct-2512`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tools, tool_choice
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **Knowledge cutoff**: 2024-11-30T23:59:59.000Z
- **登録日**: 2024-02-26
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tools, tool_choice
...
The model excels in domains such as coding, STEM reasoning, and enterprise adaptation. It supports hybrid, on-prem, and in-VPC deployments and is optimized for integration into custom workflows. Mistral Medium 3 offers competitive accuracy relative to larger models like Claude Sonnet 3.5/3.7, Llama 4 Maverick, and Command …
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-04-30
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tools, tool_choice
...
The model excels in domains such as coding, STEM reasoning, and enterprise adaptation. It supports hybrid, on-prem, and in-VPC deployments and is optimized for integration into custom workflows. Mistral Medium 3.1 offers competitive accuracy relative to larger models like …
...
- **Context**: 131K (131,072) tok / max出力 131,072 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $0.2/1M · 出力 $1.00/1M · キャッシュ読 $0.02/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **Knowledge cutoff**: 2025-06-30T23:59:59.000Z
- **登録日**: 2025-08-13
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tools, tool_choice
...
- **Capabilities**: Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2024-04-30T00:00:00.000Z
- **登録日**: 2024-07-19
- **HF**: `mistralai/Mistral-Nemo-Instruct-2407`
- **対応パラメータ**: frequency_penalty, logit_bias, max_tokens, presence_penalty, seed, stop, temperature, top_p, response_format, structured_outputs, logprobs, top_logprobs
...
- **Context**: 262K (262,144) tok / max出力 262,144 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.075/1M · 出力 $0.3/1M · キャッシュ読 $0.0075/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-03-16
- **HF**: `mistralai/Mistral-Small-4-119B-2603`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, response_format, structured_outputs, tools, tool_choice
...
- **Provider**: mistralai
- **Context**: 256K (256,000) tok / max出力 16,384 tok
- **Modality**: text+image->text  (in: text,image → out: text)
...
- **Pricing**: 入力 $2.00/1M · 出力 $6.00/1M · キャッシュ読 $0.2/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **Knowledge cutoff**: 2024-01-31T23:59:59.000Z
- **登録日**: 2024-04-17
...
- **Context**: — tok
- **Modality**: audio->transcription  (in: audio → out: transcription)
- **Pricing**: 入力 $16.67/1M · 出力 無料/1M · Audio Seconds $1.66667e-05/second
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-08-13
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, tools, tool_choice
...
- **対応パラメータ**: response_format, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, tools, tool_choice, structured_outputs
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, seed, response_format, top_k, repetition_penalty, frequency_penalty, presence_penalty, stop, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
It sets new open-source benchmarks on HLE, BrowseComp, …
...
- **Context**: 262K (262,144) tok / max出力 262,144 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.5795/1M · 出力 $2.44/1M · キャッシュ読 $0.0976/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-04-20
...
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $2.10/1M · 出力 $10.95/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-07-16
- **HF**: `moonshotai/Kimi-K3`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, logit_bias, top_logprobs, response_format, structured_outputs, logprobs, tools, tool_choice
...
- **登録日**: 2025-07-07
- **対応パラメータ**: max_tokens, temperature, stop, response_format, structured_outputs, logprobs, top_logprobs
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, frequency_penalty, presence_penalty, top_k, repetition_penalty, response_format
...
The model is instruction-tuned with an expanded post-training corpus (~60B tokens) emphasizing reasoning traces, improving performance in math, code, STEM, and logical reasoning, while retaining broad …
...
- **Provider**: nvidia
- **Context**: 131K (131,072) tok
- **Modality**: text+image->embeddings  (in: text,image → out: embeddings)
- **Pricing**: 入力 無料/1M · 出力 無料/1M  🆓
- **Capabilities**: Seed固定
- **登録日**: 2026-02-25
- **HF**: `nvidia/llama-nemotron-embed-vl-1b-v2`
...
- **Provider**: nvidia
- **Context**: 10K (10,240) tok
- **Modality**: text+image->rerank  (in: text,image → out: rerank)
- **Pricing**: 入力 無料/1M · 出力 無料/1M  🆓
- **Capabilities**: Seed固定
- **登録日**: 2026-06-09
- **対応パラメータ**: temperature, max_tokens, seed, top_p
...
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, seed, top_p, tool_choice, tools
...
- **登録日**: 2026-03-11
- **HF**: `nvidia/NVIDIA-Nemotron-3-Super-120B-A12B-FP8`
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, seed, top_p, tools, tool_choice, structured_outputs, response_format
...
- **Context**: 262K (262,144) tok / max出力 16,384 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.5/1M · 出力 $2.20/1M · キャッシュ読 $0.1/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-06-04
...
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2026-08-13
- **HF**: `nvidia/Nemotron-3.5-ASR-Streaming-Multilingual-0.6b`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format
...
- **登録日**: 2026-06-04
- **HF**: `nvidia/Nemotron-3.5-Content-Safety`
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, seed, top_p
...
- **Context**: 16K (16,385) tok / max出力 4,096 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.25/1M · 出力 $0.75/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2021-09-30T23:59:59.000Z
- **登録日**: 2023-05-28
- **対応パラメータ**: seed, max_tokens, response_format, structured_outputs, temperature, top_p, stop, frequency_penalty, presence_penalty, logit_bias, logprobs, top_logprobs, tools, tool_choice
...
- **Context**: 128K (128,000) tok / max出力 4,096 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $5.00/1M · 出力 $15.00/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2023-12-31T23:59:59.000Z
- **登録日**: 2024-04-09
- **対応パラメータ**: seed, max_tokens, response_format, structured_outputs, temperature, top_p, stop, frequency_penalty, presence_penalty, logit_bias, logprobs, top_logprobs, tools, tool_choice
...
- **Knowledge cutoff**: 2024-06-30T23:59:59.000Z
- **登録日**: 2025-04-14
- **対応パラメータ**: seed, max_tokens, response_format, structured_outputs, tools, tool_choice, temperature, top_p
...
- **Context**: 1.04758M (1,047,576) tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $0.1/1M · 出力 $0.4/1M · キャッシュ読 $0.03/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Seed固定
- **Knowledge cutoff**: 2024-06-30T23:59:59.000Z
- **登録日**: 2025-04-14
...
- **Context**: 128K (128,000) tok / max出力 16,384 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $0.075/1M · 出力 $0.3/1M · キャッシュ読 $0.0375/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Web検索, logprobs, Seed固定
- **Knowledge cutoff**: 2023-10-31T23:59:59.000Z
- **登録日**: 2024-07-18
- **対応パラメータ**: seed, max_tokens, response_format, structured_outputs, temperature, top_p, stop, frequency_penalty, presence_penalty, web_search_options, logit_bias, logprobs, top_logprobs, prediction, tools, tool_choice
...
- **Context**: 128K (128,000) tok / max出力 16,384 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $1.25/1M · 出力 $5.00/1M · キャッシュ読 $0.625/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Web検索, logprobs, Seed固定
- **Knowledge cutoff**: 2023-10-31T23:59:59.000Z
- **登録日**: 2024-05-13
- **対応パラメータ**: seed, max_tokens, response_format, structured_outputs, temperature, top_p, stop, frequency_penalty, presence_penalty, web_search_options, logit_bias, logprobs, top_logprobs, prediction, tools, tool_choice
...
Built for broad task coverage, GPT-5.1 delivers consistent gains across math, coding, and structured analysis workloads, with more coherent long-form answers and improved tool-use reliability. It also …
...
Codex integrates into developer …
...
Beyond coding, GPT-5.3-Codex performs strongly …
...
- **Context**: 1.05M (1,050,000) tok / max出力 128,000 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $0.2/1M · 出力 $1.20/1M · キャッシュ読 $0.02/1M · キャッシュ書 $0.25/1M · Web検索 $0.01 · Web Search $0.01/1K calls
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
...
- **Context**: 1.05M (1,050,000) tok / max出力 128,000 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $2.00/1M · 出力 $12.00/1M · キャッシュ読 $0.2/1M · キャッシュ書 $2.50/1M · Web検索 $0.01 · Web Search $0.01/1K calls
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2026-02-16T00:00:00.000Z
- **登録日**: 2026-07-09
- **対応パラメータ**: max_completion_tokens, reasoning, include_reasoning, seed, response_format, structured_outputs, tools, tool_choice
...
- **登録日**: 2025-08-05
- **HF**: `openai/gpt-oss-120b`
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, tools, tool_choice, response_format
...
- **登録日**: 2025-08-05
- **HF**: `openai/gpt-oss-20b`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, response_format, structured_outputs
...
- **Knowledge cutoff**: 2023-10-31T23:59:59.000Z
- **登録日**: 2025-03-19
- **対応パラメータ**: reasoning, include_reasoning, seed, max_tokens, response_format, structured_outputs
...
The model demonstrates significant improvements over its …
...
The model demonstrates significant improvements over its predecessor, with expert testers preferring its responses 56% of the time and noting a 39% reduction in major errors on complex questions. With medium reasoning effort …
...
- **Context**: 200K (200,000) tok / max出力 100,000 tok
- **Modality**: text+file->text  (in: text,file → out: text)
- **Pricing**: 入力 $0.55/1M · 出力 $2.20/1M · キャッシュ読 $0.275/1M · Web検索 $0.01
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2023-10-31T23:59:59.000Z
- **登録日**: 2025-01-31
- **対応パラメータ**: reasoning, include_reasoning, seed, max_tokens, response_format, structured_outputs, tools, tool_choice
...
Despite its smaller size, o4-mini exhibits high accuracy in STEM tasks, visual problem solving (e.g., MathVista, MMMU), and code editing. It is especially well-suited for high-throughput scenarios …
...
- **ID**: `openai/text-embedding-3-small:batch`
- **Provider**: openai
- **Context**: 8K (8,192) tok
- **Modality**: text->embeddings  (in: text → out: embeddings)
- **Pricing**: 入力 $0.01/1M · 出力 無料/1M
...
- **登録日**: 2026-05-12
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, top_k, frequency_penalty, presence_penalty, structured_outputs
...
Reasoning can be enabled per request to trade latency for deeper analysis on harder tasks. Structured annotations are …
...
- Deep Research runs multiple searches to conduct exhaustive research. Searches are priced at $5/1000 …
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.09/1M · 出力 $0.18/1M · キャッシュ読 $0.009/1M
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力
- **登録日**: 2026-07-21
- **HF**: `poolside/Laguna-S-2.1`
- **対応パラメータ**: reasoning, include_reasoning, tools, tool_choice, temperature, max_tokens
...
- Multilingual support for over 29 …
...
- **Context**: 128K (128,000) tok / max出力 128,000 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.8/1M · 出力 $1.00/1M · キャッシュ読 $0.4/1M
- **Capabilities**: Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2024-06-30T23:59:59.000Z
- **登録日**: 2025-02-01
- **HF**: `Qwen/Qwen2.5-VL-72B-Instruct`
- **対応パラメータ**: max_tokens, temperature, top_p, frequency_penalty, presence_penalty, repetition_penalty, seed, stop, top_k, logit_bias, structured_outputs, response_format, logprobs, top_logprobs
...
- **Context**: 262K (262,144) tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.0875/1M · 出力 $0.35/1M · キャッシュ読 $0.0175/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2025-06-30T23:59:59.000Z
- **登録日**: 2025-07-21
- **HF**: `Qwen/Qwen3-235B-A22B-Instruct-2507`
- **対応パラメータ**: max_tokens, temperature, top_p, seed, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
Compared to its base variant, this version delivers significant gains in knowledge coverage, long-context reasoning, coding benchmarks, and alignment with open-ended tasks. It is particularly strong on multilingual understanding, math reasoning (e.g., AIME, HMMT), and …
...
The model is instruction-tuned and excels at step-by-step reasoning, tool use, agentic workflows, and …
...
- **対応パラメータ**: reasoning, include_reasoning, response_format, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, tools, tool_choice, logit_bias, structured_outputs
...
Significantly outperforming prior models like QwQ and Qwen2.5, Qwen3 delivers superior mathematics, coding, commonsense reasoning, creative writing, and interactive dialogue capabilities. The Qwen3-30B-A3B variant includes 30.5 billion parameters (3.3 billion activated), 48 layers, 128 experts (8 activated per …
...
- **対応パラメータ**: structured_outputs, response_format, max_tokens, temperature, top_p, seed, top_k, repetition_penalty, frequency_penalty, presence_penalty, stop, tools, tool_choice, logprobs, top_logprobs
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, tools, tool_choice, response_format, structured_outputs
...
- **Knowledge cutoff**: 2025-06-30T23:59:59.000Z
- **登録日**: 2025-09-17
- **対応パラメータ**: max_tokens, temperature, top_p, seed, presence_penalty, response_format, tools, tool_choice, logprobs, top_logprobs, top_k, frequency_penalty, stop
...
- **Provider**: qwen
- **Context**: 32K (32,768) tok / max出力 32,000 tok
- **Modality**: text->embeddings  (in: text → out: embeddings)
- **Pricing**: 入力 $0.01/1M · 出力 無料/1M
- **Capabilities**: logprobs, Seed固定
- **登録日**: 2025-10-28
- **HF**: `Qwen/Qwen3-Embedding-8B`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, logit_bias, logprobs, top_logprobs
...
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, top_k, frequency_penalty, repetition_penalty, presence_penalty, max_tokens, response_format, structured_outputs
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, seed, presence_penalty, response_format, tool_choice, tools, logprobs, top_logprobs, top_k, frequency_penalty, stop
...
- **Context**: 262K (262,144) tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.17/1M · 出力 $0.25/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-03-10
- **HF**: `Qwen/Qwen3.5-9B`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, tools, tool_choice, structured_outputs, response_format
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-02-25
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, seed, presence_penalty, response_format, tools, tool_choice, structured_outputs, top_k, frequency_penalty, stop
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-02-16
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, seed, presence_penalty, response_format, tool_choice, tools, structured_outputs, logprobs, top_logprobs, top_k, frequency_penalty, stop
...
- **Context**: 1M (1,000,000) tok / max出力 131,072 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.32/1M · 出力 $1.28/1M · キャッシュ読 $0.064/1M · キャッシュ書 $0.4/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-06-03
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
- **Provider**: qwen
- **Context**: 1.01M (1,010,000) tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $2.00/1M · 出力 $6.00/1M · キャッシュ読 $0.25/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-08-12
- **HF**: `Qwen/Qwen3.8-2.4T-A95B`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, top_k, frequency_penalty, presence_penalty, repetition_penalty, stop, max_tokens, seed, min_p, logit_bias, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
Supports the following `image_config` parameters: `strength` (controls how much the output deviates from the source image), `rgb_colors` (sets a color palette), and `background_rgb_color` (sets the background color). See the image generation docs for details: …
...
- **Context**: 65K (65,536) tok
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.21/image
- **登録日**: 2026-05-13

Recraft V4.1 Pro is an image generation model from Recraft tuned for high aesthetics. It supports text and image inputs with image output at ~2K resolution across multiple aspect ratios - double the resolution of V4.1 - with typical generation around 10 seconds. It shares the V4.1 visual sensibility at higher fidelity and detail density, with more natural photorealism, smoother 3D rendering and gradients, and stronger short-prompt adherence than V4 Pro.

Suited for production work where image quality is the priority and the idea benefits from more resolution to breathe. Supports the following `image_config` parameters: `strength` (controls how much the output deviates from the source …
...
V4.1 improvements over V4 include more natural object understanding, sharper mockups, cleaner default icons, and stronger prompt adherence with shorter prompts. Supports the following …
...
V4.1 improvements over V4 Pro include more natural object understanding, sharper mockups, cleaner default icons, and stronger prompt adherence with shorter prompts. Suited for product imagery, e-commerce mockups, and structured visuals …
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), Reasoning(思考), logprobs, Seed固定
- **登録日**: 2026-03-20
- **HF**: `RekaAI/reka-edge-2603`
- **対応パラメータ**: tool_choice, tools, top_k, top_p, stop, seed, temperature, frequency_penalty, presence_penalty, max_tokens, structured_outputs, logprobs, top_logprobs, reasoning
...
- **Context**: 1M (1,000,000) tok / max出力 128,000 tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $2.00/1M · 出力 $6.00/1M · キャッシュ読 $0.25/1M · Web検索 $0.01 · Web Search $0.01/1K calls
...
Fugu Ultra is the higher-performance model in Sakana AI's Fugu family. Rather than a single monolithic model, Fugu is a learned multi-agent orchestration system: a language model trained to route tasks across a swappable pool of underlying models and to recursively call instances of itself.
...
- **Pricing**: 入力 $5.00/1M · 出力 $30.00/1M · キャッシュ読 $0.5/1M · Web検索 $0.01 · Web Search $0.01/1K calls
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), Reasoning(思考), Reasoning出力, Web検索
- **Knowledge cutoff**: 2026-08-28T00:00:00.000Z
- **登録日**: 2026-09-11
- **対応パラメータ**: reasoning, include_reasoning, tools, tool_choice, structured_outputs, web_search_options

Fugu Ultra v2 is the higher-performance model in Sakana AI's Fugu family. Rather than a single monolithic model, Fugu is a learned multi-agent orchestration system: a language model trained to route tasks across a fixed pool of open and specialized models and to recursively call instances of itself.

Fugu Ultra v2 prioritizes answer quality on complex multi-step reasoning, autonomous research, and full-stack software development, and does not rely on individual proprietary frontier models in its pool. It supports configurable reasoning effort (high, xhigh, max), function calling, structured outputs, image and PDF input, and built-in web search. Prompts above 272K tokens are billed at a …
...
Sakana Namazu is a Japanese-specialized reasoning model from Sakana AI, based on Kimi K2.6 with additional training for Japanese language and business contexts. It is suited for Japanese instruction following, business writing, mathematics, coding, research, and multi-step agent workflows.
...
- **対応パラメータ**: max_tokens, temperature, top_p, frequency_penalty, presence_penalty, repetition_penalty, seed, stop, top_k, logit_bias, response_format, structured_outputs, logprobs, top_logprobs
...
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, response_format, structured_outputs, logprobs, top_logprobs, repetition_penalty, seed
...
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2025-11-18
- **HF**: `sentence-transformers/all-MiniLM-L12-v2`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format
...
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2025-11-18
- **HF**: `sentence-transformers/multi-qa-mpnet-base-dot-v1`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format
...
- **Capabilities**: JSON mode, Seed固定
- **登録日**: 2025-11-18
- **HF**: `sentence-transformers/paraphrase-MiniLM-L6-v2`
- **対応パラメータ**: max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format
...
- **Context**: 32K (32,768) tok
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.019〜$0.021/image
- **Capabilities**: Reasoning(思考), Reasoning出力
- **登録日**: 2026-06-04
...
- **Context**: 32K (32,768) tok
- **Modality**: text+image->image  (in: text,image → out: image)
- **Pricing**: 入力 無料/1M · 出力 無料/1M · Image Output $0.13〜$0.17/image
- **Capabilities**: Reasoning(思考), Reasoning出力
- **登録日**: 2026-06-04
- **対応パラメータ**: reasoning, include_reasoning
...
- **Context**: 8K (8,192) tok / max出力 4,096 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.044/1M · 出力 $0.177/1M
- **登録日**: 2026-08-20
- **HF**: `tencent/Hy-MT2-1.8B`
- **対応パラメータ**: temperature, stop, max_completion_tokens, max_tokens
...
- **Context**: 262K (262,144) tok / max出力 131,072 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.07/1M · 出力 $0.29/1M · キャッシュ読 $0.0175/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-07-06
- **HF**: `tencent/Hy3`
...
- **対応パラメータ**: reasoning, include_reasoning, temperature, stop, max_completion_tokens, reasoning_effort, max_tokens, response_format, structured_outputs, tools, tool_choice
...
- **Provider**: thedrummer
- **Context**: 1.024M (1,024,000) tok / max出力 1,024,000 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.4/1M · 出力 $0.4/1M
- **Capabilities**: Structured outputs(JSONスキーマ), logprobs, Seed固定
- **Knowledge cutoff**: 2024-04-30T23:59:59.000Z
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, tools, tool_choice, logit_bias
...
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-07-30
- **HF**: `thinkingmachines/Inkling-Small`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, min_p, tools, tool_choice, logprobs, top_logprobs
...
- **Modality**: text+image+audio->text  (in: text,image,audio → out: text)
- **Pricing**: 入力 無料/1M · 出力 無料/1M  🆓
- **Capabilities**: Function calling, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-07-30
- **HF**: `thinkingmachines/Inkling-Small`
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, max_tokens, stop, frequency_penalty, presence_penalty, seed, tools
...
- **Provider**: undi95
- **Context**: 6K (6,144) tok / max出力 6,144 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.35/1M · 出力 $0.65/1M
- **Capabilities**: Structured outputs(JSONスキーマ), JSON mode, logprobs, Seed固定
- **Knowledge cutoff**: 2023-06-30T23:59:59.000Z
- **登録日**: 2023-07-22
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-01-27
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, tools, tool_choice, structured_outputs, response_format, top_p, frequency_penalty, presence_penalty, parallel_tool_calls
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.09/1M · 出力 $0.36/1M · キャッシュ読 $0.018/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-08-10
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, response_format, structured_outputs, tools, tool_choice, top_p, frequency_penalty, presence_penalty, parallel_tool_calls
...
voyage-code-4 is a code embedding model from Voyage AI, a MongoDB company. It is designed for coding agents and code retrieval, with Matryoshka embeddings at 2048, 1024, 512, and 256 dimensions and multiple quantization options. Learn more about voyage-code-4 here: [blog.voyageai.com/2026/08/13/voyage-code-4](https://blog.voyageai.com/2026/08/13/voyage-code-4)
...
- **登録日**: 2026-01-21
- **対応パラメータ**: max_tokens, temperature, top_p, top_k, stop
...
- **Context**: 1M (1,000,000) tok
- **Modality**: text+image+file->text  (in: text,image,file → out: text)
- **Pricing**: 入力 $1.00/1M · 出力 $2.00/1M · キャッシュ読 $0.16/1M · Web検索 $0.005 · Web Search $0.005/1K calls
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-04-30
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, logprobs, top_logprobs, tools, tool_choice
...
- **Modality**: text+image+audio+video->text  (in: text,image,audio,video → out: text)
- **Pricing**: 入力 $0.119/1M · 出力 $0.238/1M · キャッシュ読 $0.0026/1M
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-04-22
...
- **Context**: 1.05M (1,050,000) tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.3045/1M · 出力 $0.609/1M · キャッシュ読 $0.0028/1M
- **Capabilities**: JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-04-22
...
- **Context**: 131K (131,072) tok / max出力 98,304 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.13/1M · 出力 $0.85/1M · キャッシュ読 $0.025/1M
- **Capabilities**: Function calling, Tool choice, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2024-12-31T23:59:59.000Z
- **登録日**: 2025-07-25
...
- **ID**: `z-ai/glm-4.6`
- **Provider**: z-ai
- **Context**: 204K (204,800) tok / max出力 16,384 tok
- **Modality**: text->text  (in: text → out: text)
...
More capable agents: GLM-4.6 exhibits stronger performance …
...
- **Context**: 131K (131,072) tok / max出力 32,768 tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.3/1M · 出力 $0.9/1M · キャッシュ読 $0.055/1M
- **Capabilities**: Function calling, Tool choice, JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2025-12-08
- **HF**: `zai-org/GLM-4.6V`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, repetition_penalty, tools, tool_choice, response_format
...
- **登録日**: 2026-02-11
- **HF**: `zai-org/GLM-5`
- **対応パラメータ**: reasoning, include_reasoning, tool_choice, tools, max_tokens, temperature, top_p, stop, response_format, structured_outputs, logprobs, top_logprobs
...
- **Context**: 1.04858M (1,048,576) tok / max出力 131,072 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.4802/1M · 出力 $1.51/1M · キャッシュ読 $0.0892/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-06-16
- **HF**: `zai-org/GLM-5.2`
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, max_tokens, frequency_penalty, presence_penalty, repetition_penalty, stop, response_format, structured_outputs, tools, tool_choice
...
- **Context**: 1.04858M (1,048,576) tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.7/1M · 出力 $2.20/1M · キャッシュ読 $0.07/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-06-16
- **HF**: `zai-org/GLM-5.2`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, logprobs, top_logprobs, response_format, structured_outputs, tool_choice, tools
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.936/1M · 出力 $3.17/1M · キャッシュ読 $0.1872/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-18
- **HF**: `zai-org/GLM-5.3`
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, top_k, max_tokens, stop, seed, frequency_penalty, presence_penalty, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs
...
- **Context**: 1.04858M (1,048,576) tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.7/1M · 出力 $2.20/1M · キャッシュ読 $0.13/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-08-18
- **HF**: `zai-org/GLM-5.3`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, repetition_penalty, logit_bias, logprobs, top_logprobs, response_format, structured_outputs, tools, tool_choice
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-01
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, max_tokens, stop, response_format, structured_outputs, tools, tool_choice, seed, frequency_penalty, presence_penalty, top_k, min_p, logit_bias, repetition_penalty, logprobs, top_logprobs, parallel_tool_calls, reasoning_effort, top_a
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-04-27
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, seed, response_format, structured_outputs, tool_choice, tools, stop
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-04-27
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, logit_bias, top_logprobs, response_format, structured_outputs, logprobs, tools, tool_choice, repetition_penalty
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-07-08
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, response_format, max_tokens, temperature, top_p, seed, logprobs, top_logprobs, tools, tool_choice, top_k, stop
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-27
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, response_format, logit_bias, structured_outputs, tools, tool_choice, logprobs, top_logprobs, reasoning_effort
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-19
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, top_k, max_tokens, stop, seed, frequency_penalty, presence_penalty, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs, min_p, repetition_penalty, logit_bias, parallel_tool_calls, reasoning_effort
