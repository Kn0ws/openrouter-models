# OpenRouter モデルカタログ（全619モデル）

- 取得日時: 2026-09-25T06:42:14
- プロバイダ数: 83 / 無料枠あり: 32
...
| deepseek | 16 | 0.03 | 0.80 | 1,310,720 |
...
| ~deepseek | 3 | 0.03 | 0.26 | 1,310,720 |
...
| ~moonshotai | 1 | 0.88 | 0.88 | 1,048,576 |
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-09-01
- **対応パラメータ**: reasoning, include_reasoning, structured_outputs, max_tokens, max_completion_tokens, tool_choice, tools, response_format, verbosity, stop
...
- **Capabilities**: Function calling, Tool choice, JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-09-22
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, stop, tool_choice, tools, response_format, verbosity
...
The model completes comparable tasks in fewer steps and with fewer tokens than Opus 5, and reports on its work in plainer language, with clear updates on what it did, what it found, and what it needs from the user. Thinking is always adaptive, so effort is the main lever …
...
- **Provider**: cohere
- **Context**: 192K (192,000) tok / max出力 64,000 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.3/1M · 出力 $1.50/1M · キャッシュ読 $0.15/1M
- **Capabilities**: Function calling, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-09-22
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, top_k, seed, structured_outputs, response_format, tools
...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.7858/1M · 出力 $1.57/1M · キャッシュ読 $0.0651/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-04-24
...
- **Context**: 1.04858M (1,048,576) tok / max出力 1,048,576 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.26/1M · 出力 $3.50/1M · キャッシュ読 $0.25/1M
...
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.04/1M · 出力 $0.49/1M · キャッシュ読 $0.01/1M
...
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.112/1M · 出力 $0.336/1M · キャッシュ読 $0.0034/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-09-10
- **HF**: `deepseek-ai/DeepSeek-V4.1-Flash`
...
- **Provider**: google
- **Context**: 98K (98,304) tok / max出力 32,768 tok
- **Modality**: audio->transcription  (in: audio → out: transcription)
- **Pricing**: 入力 $2.00/1M · 出力 $12.00/1M
- **登録日**: 2026-09-25
...
- **Capabilities**: Seed固定
- **登録日**: 2026-09-22
- **HF**: `inclusionAI/Ming-Image-0.1-Design`
...
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, repetition_penalty, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs, max_completion_tokens
...
- **Context**: 262K (262,144) tok / max出力 262,144 tok
- **Modality**: text+image->text  (in: text,image → out: text)
- **Pricing**: 入力 $0.4522/1M · 出力 $1.90/1M · キャッシュ読 $0.0762/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-04-20
...
- **対応パラメータ**: reasoning, include_reasoning, temperature, max_tokens, top_p, stop, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs, frequency_penalty, logit_bias, parallel_tool_calls, presence_penalty, seed
...
- **Context**: 1.04858M (1,048,576) tok / max出力 1,048,576 tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.8845/1M · 出力 $10.53/1M · キャッシュ読 $0.33/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-07-16
...
- **Context**: 1.04858M (1,048,576) tok / max出力 16,384 tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $2.28/1M · 出力 $11.40/1M · キャッシュ読 $0.228/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-07-16
- **HF**: `moonshotai/Kimi-K3`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, logit_bias, structured_outputs, response_format, tools, tool_choice
...
- **Context**: 131K (131,072) tok / max出力 131,072 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.024/1M · 出力 $0.112/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **Knowledge cutoff**: 2024-06-30T23:59:59.000Z
- **登録日**: 2025-08-05
- **HF**: `openai/gpt-oss-20b`
...
- **Context**: 1M (1,000,000) tok / max出力 131,072 tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.092/1M · 出力 $4.40/1M · キャッシュ読 $0.085/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-14
- **HF**: `Qwen/Qwen3.8-27B`
...
The model was trained with a longer reinforcement learning run weighted toward problems that take many hours to complete, and natively understands the Grok Bot harness for conversational tasks. It ships with a new safeguard stack that pairs strong jailbreak resistance with low refusal rates for legitimate cybersecurity and biology work. SpaceXAI's reported …
...
- **Context**: 1.04858M (1,048,576) tok / max出力 131,072 tok
- **Modality**: text+image+audio+video->text  (in: text,image,audio,video → out: text)
- **Pricing**: 入力 $4.35/1M · 出力 $8.70/1M · キャッシュ読 $0.036/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-09-21
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, response_format, tools, tool_choice, frequency_penalty, presence_penalty, structured_outputs
...
- **Context**: 1.04858M (1,048,576) tok / max出力 131,072 tok
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.5614/1M · 出力 $1.76/1M · キャッシュ読 $0.1043/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力
- **登録日**: 2026-06-16
- **HF**: `zai-org/GLM-5.2`
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, max_tokens, frequency_penalty, presence_penalty, repetition_penalty, stop, response_format, structured_outputs, tools, tool_choice
...
- **Context**: 1.04858M (1,048,576) tok / max出力 131,072 tok
- **Modality**: text+image+video->text  (in: text,image,video → out: text)
- **Pricing**: 入力 $0.06/1M · 出力 $0.2/1M · キャッシュ読 $0.012/1M
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, Seed固定
- **登録日**: 2026-08-26
- **HF**: `zai-org/GLM-5.3-Flash`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, repetition_penalty, top_k, seed, min_p, logit_bias, structured_outputs, tools, tool_choice, response_format
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-27
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, top_p, stop, frequency_penalty, presence_penalty, seed, top_k, min_p, logit_bias, response_format, structured_outputs, tools, tool_choice, logprobs, top_logprobs, repetition_penalty, parallel_tool_calls, reasoning_effort
...
- **Capabilities**: Function calling, Tool choice, Structured outputs(JSONスキーマ), JSON mode, Reasoning(思考), Reasoning出力, logprobs, Seed固定
- **登録日**: 2026-08-19
- **対応パラメータ**: reasoning, include_reasoning, temperature, top_p, max_tokens, frequency_penalty, presence_penalty, repetition_penalty, stop, response_format, structured_outputs, tools, tool_choice, top_k, seed, min_p, logit_bias, logprobs, top_logprobs, reasoning_effort, parallel_tool_calls
