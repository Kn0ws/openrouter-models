...
- **Modality**: text->text  (in: text → out: text)
- **Pricing**: 入力 $0.12/1M · 出力 $0.48/1M
- **Capabilities**: Function calling, Tool choice, JSON mode, Reasoning(思考), Reasoning出力, logprobs
- **登録日**: 2026-02-13
- **HF**: `MiniMaxAI/MiniMax-M2.5`
- **対応パラメータ**: reasoning, include_reasoning, max_tokens, temperature, stop, top_k, top_p, response_format, logprobs, top_logprobs, tools, tool_choice
